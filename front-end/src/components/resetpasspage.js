...
const Resetpasspage = () => {
    ...
    const getUserDetails = async () => {
        ...
        let result = await fetch(`http://localhost:5000/getUserbyemailid/${emailid}`);
    ...
    //     let result = fetch(`http://localhost:5000/getUserbyemailid/${emailid}`, {
    //         method: 'Put',
    ...
    return (
        <div className="divsgn">
            ...
            <button onClick={getUserDetails} className="btnsn" type="button">confirm</button>
        </div>
    )
